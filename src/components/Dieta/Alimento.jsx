  ...
  return (
    <div className="producto tw-min-h-[252px]" key={producto.id}>
      <div className="tw-text-sm tw-justify-between tw-bg-gray-200 tw-rounded-md tw-w-[20.5rem]" >
        ...
        <div className="tw-flex tw-gap-2 tw-items-center tw-justify-center tw-bg-gray-300 tw-cursor-pointer" onMouseEnter={() => setCaracteristicasVisibles(true)} onMouseLeave={() => setCaracteristicasVisibles(false)}  onClick={() =>setCaracteristicasVisibles(!caracteristicasVisibles)}>
          ...
          {caracteristicasVisibles && (
            <div className="tw-w-4/5 tw-flex tw-flex-wrap tw-h-[12rem] tw-text-pretty tw-text-center tw-p-2 tw-transition-opacity tw-duration-500 ">
